...
Щоденно тягне з Garmin Connect: сон, HRV, Body Battery, пульс спокою, кроки, стрес, тренування за вчора — і пише рядок у Notion-таблицю. Звідти я (Claude) можу читати дані через Notion MCP і робити аналітику/тренди в будь-який момент, без ручного експорту.
